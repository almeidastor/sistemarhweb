...
<%
    ...
    boolean usuarioLogado = (request.getSession().getAttribute("usuarioLogado") != null);
    if (!usuarioLogado) {
...
<div class="header" id="topo"><nav class="navtoggle">
	<div id=div-logo-nav><img id=horizont-logo-nav src="images/logo/mini.png"></div>
		...
		<div class="toggle">
			...
			<a href="main.jsp"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-house-fill"  id="icon-nav-mobile" viewBox="0 0 16 16">
  <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L8 2.207l6.646 6.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.707 1.5Z"/>
  <path d="m8 3.293 6 6V13.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5V9.293l6-6Z"/>
</svg></a>

						
 			 <svg xmlns="http://www.w3.org/2000/svg" width="40" height="auto" fill="currentColor" class="fa fa-bars menu"  id="icon-nav-mobile" viewBox="0 0 16 16">
...
<div>
    <img id="imagem" src="#" alt="Foto" width="300">
  </div>
<input type="file" accept="image/*" onchange="exibirFoto(event)">
...
<footer> 
	<div class="footer">
		...
		<p><img id=logofooter src="images/logo/1080.png"></p>
	</div>
	...
	<div id=footer-frame3>
		...
		<p>
			...
			<a href="linkedin.com/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" fill="#e5e5e5" class="bi bi-linkedin" id=iconsocial1 viewBox="0 0 16 16">
